<!--
README_ja.md - Last modified: 28-Mar-2026 (kobayasy)
-->
...
```sh
curl -LOJs https://github.com/kobayasy/syncTimeICOM/releases/download/1.4/syncTimeICOM-1.4.tar.gz
tar xzf syncTimeICOM-1.4.tar.gz
cd syncTimeICOM-1.4
