<!--
README_ja.md - Last modified: 05-Apr-2026 (kobayasy)
-->
...
<img src="syncTimeICOM.png" alt="syncTimeICOM" align="right">
...
```sh
curl -LOJs https://github.com/kobayasy/syncTimeICOM/releases/download/1.5/syncTimeICOM-1.5.tar.gz
tar xzf syncTimeICOM-1.5.tar.gz
cd syncTimeICOM-1.5
...
$ syncTimeICOM --utc /dev/cu.usbserial-110
Power on
[ Waiting  0s until exactly 09:18:00 UTC ]
Synchronised to 09:18:00 UTC
Power off
$ 
```
